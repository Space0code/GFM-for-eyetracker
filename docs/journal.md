...
### Emotion: Anger
Complete results in `results/binary/RETAIN_2026-02-12_19-05-24`.
...
| SVM      | 0.523    | 0.576     | 0.780  | 0.606 | 0.588 |
| LightGBM | 0.524    | 0.578     | 0.781  | 0.609 | 0.556 |
| MLP      | 0.556    | 0.590     | 0.713  | 0.602 | 0.583 |
| GNN      | 0.559    | 0.559     | 1.000  | 0.676 | 0.503 |
...
| MLP      | 0.570    | 0.630     | 0.663  | 0.620 | 0.538 |
| GNN      | 0.602    | 0.602     | 1.000  | 0.728 | 0.543 |

### Emotion: Disgust
`RETAIN_2026-02-12_19-19-45`

#### Recording LOO

| Model    | Accuracy | Precision | Recall | F1    | AUC   |
|----------|----------|-----------|--------|-------|-------|
| Mean     | 0.284    | 0.238     | 0.700  | 0.284 | 0.400 |
| SVM      | 0.382    | 0.492     | 0.654  | 0.393 | 0.429 |
| LightGBM | 0.395    | 0.504     | 0.588  | 0.386 | 0.407 |
| MLP      | 0.474    | 0.506     | 0.614  | 0.417 | 0.471 |
| GNN      | 0.559    | 0.559     | 1.000  | 0.676 | 0.500 |

#### Subject LOO

| Model    | Accuracy | Precision | Recall | F1    | AUC   |
|----------|----------|-----------|--------|-------|-------|
| Mean     | 0.550    | 0.550     | 1.000  | 0.698 | 0.500 |
| SVM      | 0.537    | 0.589     | 0.708  | 0.607 | 0.599 |
| LightGBM | 0.555    | 0.598     | 0.690  | 0.613 | 0.607 |
| MLP      | 0.556    | 0.613     | 0.591  | 0.577 | 0.596 |
| GNN      | 0.602    | 0.602     | 1.000  | 0.728 | 0.543 |

### Emotion: Sadness
`RETAIN_2026-02-12_19-34-11`

#### Recording LOO

| Model    | Accuracy | Precision | Recall | F1    | AUC   |
|----------|----------|-----------|--------|-------|-------|
| Mean     | 0.585    | 0.585     | 1.000  | 0.671 | 0.500 |
| SVM      | 0.548    | 0.595     | 0.831  | 0.617 | 0.627 |
| LightGBM | 0.528    | 0.594     | 0.830  | 0.607 | 0.615 |
| MLP      | 0.553    | 0.607     | 0.727  | 0.589 | 0.627 |
| GNN      | 0.559    | 0.559     | 1.000  | 0.676 | 0.499 |

#### Subject LOO

| Model    | Accuracy | Precision | Recall | F1    | AUC   |
|----------|----------|-----------|--------|-------|-------|
| Mean     | 0.631    | 0.631     | 1.000  | 0.758 | 0.468 |
| SVM      | 0.608    | 0.667     | 0.832  | 0.709 | 0.599 |
| LightGBM | 0.605    | 0.664     | 0.832  | 0.708 | 0.557 |
| MLP      | 0.576    | 0.663     | 0.695  | 0.657 | 0.547 |
| GNN      | 0.602    | 0.602     | 1.000  | 0.728 | 0.545 |

### Emotion: Tenderness
`RETAIN_2026-02-12_19-45-27`
...
| SVM      | 0.612    | 0.336     | 0.176  | 0.116 | 0.514 |
...
| LightGBM | 0.692    | 0.382     | 0.168  | 0.204 | 0.639 |
| MLP      | 0.672    | 0.423     | 0.366  | 0.355 | 0.655 |
| GNN      | 0.602    | 0.602     | 1.000  | 0.728 | 0.546 |
