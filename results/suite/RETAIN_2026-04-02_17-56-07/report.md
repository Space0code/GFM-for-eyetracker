...
| Experiment | Best Baseline (f1) | GNN f1 | Delta f1 | Baseline AUC | GNN AUC | Delta AUC | Baseline BalAcc | GNN BalAcc | Delta BalAcc |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| Table6 Arousal 3-class | 0.3471 (MLP) | 0.4387 | +0.0916 | 0.5815 | 0.6761 | +0.0945 | 0.3658 | 0.4478 | +0.0820 |
| Table6 Valence 3-class | 0.4259 (SVM) | 0.5205 | +0.0946 | 0.6468 | 0.7155 | +0.0686 | 0.4486 | 0.5322 | +0.0836 |
